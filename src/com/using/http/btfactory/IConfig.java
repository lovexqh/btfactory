...
public class IConfig {
	...
	// 下载种子存放主目录
	public static final String TORRENT_OUT_PATH = "D://test//torrent//";
	
	// 临时内容存放的文件夹名称
	public static final String CONTEXT_FOLDER_NAME = "tmp//";
	...
	public final static String BT_BASE_PATH = "http://97.11bt.info/";
	
	// BT工场的列表内容地址 xx.html代表月份
	public final static String BT_CONTEXTURL = "/00/08.html";
